...
import { completeChallengeApi } from '../../lib/challenges';
import {
  Pressable,
  StyleSheet,
  Text,
      ...
      <Card>
        ...
        <View style={styles.optionsRow}>
            ...
            >
              <Text
                style={[
                  styles.optionText,
                  difficoltaAttesa === difficulty.value && styles.optionTextSelected,
                ]}
              >
                {difficulty.label}
              </Text>
        ...
        <View style={styles.optionsRow}>
              ...
              <Pressable
                ...
                style={[
                  styles.option,
                  difficoltaPercepita === difficulty.value && styles.optionSelected,
                ]}
              ...
              >
                <Text
                  style={[
                    styles.optionText,
                    difficoltaPercepita === difficulty.value && styles.optionTextSelected,
                  ]}
                >
                  {difficulty.label}
                </Text>
